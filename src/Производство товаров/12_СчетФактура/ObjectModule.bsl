...
Процедура СчетФактура() Экспорт
	...
	СчетаФактуры = Документы.СчетФактураВыданный.СчетаФактурыПоОснованию(СтруктураДанных.РТУ, ПараметрыОтбора, РеквизитыСчетаФактуры);
	...
	Иначе
		...
		ДокументОбъект.Дата = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(СтруктураДанных.РТУ, "Дата");
	КонецЕсли;	
	
	ДанныеЗаполнения = Новый Структура;
	ДанныеЗаполнения.Вставить("ДокументОснование", СтруктураДанных.РТУ);
