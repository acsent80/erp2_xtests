...
Процедура ЗаполнитьНаборТестов(НаборТестов) Экспорт
	...
	НаборТестов.Добавить("ПечатнаяФорма", НаборТестов.ПараметрыТеста("Инвойс_ENG"),      "Инвойс_ENG");
	НаборТестов.Добавить("ПечатнаяФорма", НаборТестов.ПараметрыТеста("PackingList_ENG"), "PackingList_ENG");
...
Процедура ПечатнаяФорма(ИмяФормы) Экспорт
	...
	ТабОригинал = ПолучитьМакет(ИмяФормы);
	ТабДокумент = Печать(СтруктураДанных.ЗаказКлиента1, ИмяФормы);
