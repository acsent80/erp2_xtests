...
Процедура ЗачетАвансаНераспределенныеПлатежиБезДоговора() Экспорт
	...
	// Должно быть 2000, но на самом деле 10000
	// Пустьбудет ошибка, когда исправят
	//Утверждения.ПроверитьРавенство(ДоступноКЗачету, 2000, "Не верная сумма доступно к зачету");
	Утверждения.ПроверитьРавенство(ДоступноКЗачету, 10000, "А на самом деле должно быть 2000");
