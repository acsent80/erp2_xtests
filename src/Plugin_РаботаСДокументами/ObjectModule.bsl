...
Процедура УдалитьДокументыПоОрганизации(Организация) Экспорт
	...
	ДобавитьДокумент(Таблица, "Документ.ДвижениеПродукцииИМатериалов");
	...
	ДобавитьДокумент(Таблица, "Документ.ЭтапПроизводства2_2");
	...
	ДобавитьДокумент(Таблица, "Документ.ЗаказНаПроизводство2_2");
	...
	ДобавитьДокумент(Таблица, "СостоянияЗаказовКлиентов",    "Рег.Заказ.Организация");
	ДобавитьДокумент(Таблица, "СостоянияЗаказовПоставщикам", "Рег.Заказ.Организация");
	ДобавитьДокумент(Таблица, "СостоянияЗаказовНаПроизводство", "Рег.Заказ.Организация");
...
Процедура ЗакрытьМесяц(Организация, ЗакрываемыйПериод) Экспорт
	...
	ОбщегоНазначенияУТ.ВыполнитьЗакрытиеМесяца(Организация);
