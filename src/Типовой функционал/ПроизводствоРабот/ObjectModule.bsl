...
Процедура ВыработкаСотрудников() Экспорт
	...
	ПараметрыФормы.Вставить("Распоряжения",    МассивСсылок);
	ПараметрыФормы.Вставить("ПоРаспоряжениям", Истина);
	...
	ПараметрыФормы.Вставить("Автораспределение", Истина);
...
Процедура РасчетСебестоимости() Экспорт
	...
	РаботаСДокументами.ЗакрытьМесяц(СтруктураДанных.Организация, '2016-01-01');
