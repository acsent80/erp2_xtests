...
Процедура ЗаполнитьНаборТестов(НаборТестов) Экспорт
	...
	ЗаполнитьНаборТестовСервер(НаборТестов);
	Возврат;
...
&НаСервере
Процедура ЗаполнитьНаборТестовСервер(НаборТестов)
	
	ВидыСправочников = Новый Массив;
	ВидыСправочников.Добавить("лфВидОценки");
	ВидыСправочников.Добавить("лфВидыНарушений");
	ВидыСправочников.Добавить("лфВыдела");
	ВидыСправочников.Добавить("лфЛеснойФонд");
	ВидыСправочников.Добавить("лфЛесосеки");
	ВидыСправочников.Добавить("лфПериодыРубки");
	ВидыСправочников.Добавить("лфПороды");
	ВидыСправочников.Добавить("лфСпособыРубки");
	ВидыСправочников.Добавить("лфТехнологииЛесозаготовок");
	ВидыСправочников.Добавить("лфХозяйства");
	ВидыСправочников.Добавить("лфЦелевыеНазначенияЛесов");
	
	НаборТестов.НачатьГруппу("Справочники", Истина);
	
	Для каждого ИмяСправочника из ВидыСправочников Цикл
		
		Для каждого ФормаОбъекта из Метаданные.Справочники[ИмяСправочника].Формы Цикл
			НаборТестов.Добавить("ТестДолжен_ОткрытьФормуСправочника", НаборТестов.ПараметрыТеста(ИмяСправочника, ФормаОбъекта.ИмяФормы), ИмяСправочника + "." + ФормаОбъекта.ИмяФормы);
		Конеццикла;
